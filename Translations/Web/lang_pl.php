...
$content_defaultapp_text = 'Potrzebujesz <a href="https://github.com/aonez/Keka/wiki/Default-application">programu pomocnicznego<i class="far fa-question-circle"></i></a>, aby ustawić Keka jako domyślny archiwizator plików.<br />Pobierz i wypakuj program, przenieś go na Biurko i uruchom. I już!';

// Privacy Policy
$content_privacypolicy_title = 'Polityka prywatności';

// Terms of use
$content_termsofuse_title = 'Warunki korzystania';

// Main content of the page
$content_context_menu = "Menu kontekstowe";

// Changelog info
$content_changelog_title = "Zobacz jak rozwijał się program Keka";
$content_changelog_entry_title = "Zmiany w wersji";
$content_changelog_firstpublic = "Pierwsza publiczna wersja programu:";
