...
$content_donation_mas = "If you buy Keka from the App Store, you will get the same as in this web<br />but it will be always updated through the App Store.";
...
$content_beta_text = "You can test the newest features of Keka before they hit the stable status.<br />If you find some bug or just have anything to report, head to ";
$content_beta_unavailable = "There are no betas available at this moment.";
...
$content_legacy_text = 'Over the years your Mac will become older and will not support<br />the newest Keka, but relax <i class="fa fa-coffee" aria-hidden="true"></i>, those will be with you.';

// Info
$content_info_title1 = "So simple, so strong";
$content_info_title2 = "Privacy is very important";
$content_info_title3 = "Still too big...";
$content_info_text1 = "You do not even need to open Keka to compress a file, keep it in your dock and use it from there.<br />Just drag and drop your files and folders over it or over the Keka window to create a slimmer version of them.";
...
$content_info_text3 = "If the files are inmensely huge and they do not fit your mail or server, just split them into pieces.<br />Do not worry, they will rejoin to be your original file again :)";
$content_info_compression = "Keka can create files using this formats:";
