...
// iOS
$ios_title = "$keka para iOS";
$ios_content_title = "el compresor de iOS";
...
$content_get_platform = "Consíguelo para ";
$content_testflight = "Se necesita TestFlight para instalar esta versión";
...
$content_donation_title = 'Si te gusta Keka dale un poco de <i class="fa fa-heart" aria-hidden="true"></i>, <br />cómpralo en la App Store o envía un donativo!';
...
$content_donation_paypal = "Si no te gusta la Apple Store o simplemente quieres jugar con las entrañas de Keka<br />pero además te gusta el proyecto y quieres darle tu apoyo, puedes enviar una donación.";
...
$content_info_text2 = "Con tan solo una contraseña podrás crear ficheros altamente encriptados que podrás compartir con toda seguridad.<br />Keka utiliza la especificación AES-256 para la encriptación de tus ficheros 7z<br />y Zip 2.0 legacy para tus ficheros Zip.";
