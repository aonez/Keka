...
$content_donation_mas = "Hvis du køber Keka fra App Store støtter du udviklingen.<br />Det er det samme program, men hentet og opdateret via App Store.";
...
$content_legacy_text = 'Med tiden bliver din Mac ældre og understøtter måske ikke den<br />nyeste version af Keka, men bare tag det roligt <i class="fa fa-coffee" aria-hidden="true"></i>, ældre versioner kan findes her.';
...
$content_info_text1 = "Du behøver ikke engang at åbne Keka for at kopmprimere arkiver, bare føj Keka til din Dock.<br />Træk arkiver ind i Keka for at komprimere dem.";
...
$content_info_compression = "Keka kan oprette arkiver i disse formater:";
...
$content_info_v2_text1 = "Vælg mellem adskillige arkivformater<br />for at finde det perfekte";
$content_info_v2_text2 = "Beskyt dine delte arkiver med adgangskode<br />og krypter dem med AES-256";
...
// Default app
$content_defaultapp_title = "Angiv Keka som standardprogram til udpakning";
$content_defaultapp_text = 'Keka <a href="https://github.com/aonez/Keka/wiki/Default-application">har brug for en hjælper <i class="far fa-question-circle"></i></a> for at sætte sig selv som standardprogram.<br />Hent og udpak den, flyt den til skrivebordet og åbn den.';
...
$content_privacypolicy_content = 'Keka respekterer dit privatliv. Alle arkiver, der behandles af Keka, forbliver på din computer og sendes ikke til nogen server. Keka gemmer ikke nogen form for data om de behandlede arkiver.';
